...
¹ You might need a [hex editor](https://en.wikipedia.org/wiki/Hex_editor), or [`eval`](http://ruby-doc.org/core-2.3.1/Kernel.html#method-i-eval), to be able to use non-printable string delimiters.
