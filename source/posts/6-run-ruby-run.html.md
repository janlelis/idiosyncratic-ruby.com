...
This will fire up a very simple server, written in Ruby, using [WEBrick](http://ruby-doc.org/stdlib-2.4.0/libdoc/webrick/rdoc/WEBrick.html) under the hood!
...
There are two more commands included, which don't fit into this unix category: [mkmf](http://ruby-doc.org/stdlib-2.4.0/libdoc/mkmf/rdoc/MakeMakefile.html), which you can use to create the Makefile for a Ruby C extension and [wait_writable](https://github.com/ruby/ruby/blob/ruby_2_2/lib/un.rb#L233-L264), which allows you to continuously try to open a file in writable mode.
