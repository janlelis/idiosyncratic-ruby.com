...
This hash contains the [byte sizes of low-level data structures](https://github.com/ruby/ruby/blob/trunk/template/sizes.c.tmpl) of your system. This is useful when interacting with external libraries via [FFI](https://github.com/ffi/ffi)/[Fiddle](http://ruby-doc.org/stdlib-2.3.0/libdoc/fiddle/rdoc/Fiddle.html). I needs to be explicitely required:
