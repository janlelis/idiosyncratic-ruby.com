...
Generated with Ruby 3.1.0, including RubyGems and [DidYouMean](https://stdgems.org/did_you_mean/):
...
│ ├─KERNEL_WARN_IGNORES_INTERNAL_ENTRIES (TrueClass)
...
│ │ ├─PATTERN (Regexp)
│ │ ├─PATTERN_RAW (String)
│ │ └─SOURCE_SET_REQUIREMENT (#&lt;Class:0x00007f7a336d06c8&gt;)
│ ├─Resolver (Class)
│ │ ├─APISet (Class)
│ │ │ └─GemParser (Class)
...
│ │ ├─NOT_FOUND (#&lt;Class:0x00007f7a301af7c8&gt;)
