...
Slicing uses [===](http://ruby-doc.org/core-2.3.1/Object.html#method-i-3D-3D-3D) to compare each element with the given separator, so you can pass in a class as well:
...
- [RDoc: Enumerable#slice_*](http://ruby-doc.org/core-2.3.1/Enumerable.html#method-i-slice_after)
