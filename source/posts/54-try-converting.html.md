...
Ruby objects are usually converted to other classes/types using `to_*` functions. For example, converting the [String](http://ruby-doc.org/core-2.4.0/String.html) `"42"` to a [Float](http://ruby-doc.org/core-2.4.0/Float.html) is done with `to_f`:
...
- Raise a [TypeError](http://ruby-doc.org/core-2.4.0/TypeError.html) if everything of the above has failed

¹ Although defining uppercased methods for your custom classes to create instances of it looks like an interesting idea at first glance, it is rather confusing. Consider defining class`.[]` instead, which enables a very similar syntax, but uses the real constant it belongs to. An example of such usage is [Set](http://ruby-doc.org/stdlib-2.4.0/libdoc/set/rdoc/Set.html#method-c-5B-5D).

## Core Classes Conversion Table

 Class | `.try_convert` | Kernel Method | Kernel Method w/ `nil` | Kernel Method Special
-------|----------------|---------------|------------------------|----------------------
 Array | [Array.try_convert](http://ruby-doc.org/core-2.4.0/Array.html#method-c-try_convert) | [Array()](http://ruby-doc.org/core-2.4.0/Kernel.html#method-i-Array) | `Array(nil) # => []` | If `:to_ary` and `:to_a` did not return an array, it will create single-element array which contains the given value
 Hash | [Hash.try_convert](http://ruby-doc.org/core-2.4.0/Hash.html#method-c-try_convert) | [Hash()](http://ruby-doc.org/core-2.4.0/Kernel.html#method-i-Hash) | `Hash(nil) # => {}` | `Hash([]) # => {}`. Also remember that you can convert arrays to hashes with [Hash.[]](http://ruby-doc.org/core-2.4.0/Hash.html#method-c-5B-5D).
 String   | [String.try_convert](http://ruby-doc.org/core-2.4.0/String.html#method-c-try_convert) | [String()](http://ruby-doc.org/core-2.4.0/Kernel.html#method-i-String) | `String(nil) # => ""` | -
 ...
 Float    | - | [Float()](http://ruby-doc.org/core-2.4.0/Kernel.html#method-i-Float) | `Float(nil) # TypeError` | - ³
 Complex  | - | [Complex()](http://ruby-doc.org/core-2.4.0/Kernel.html#method-i-Complex) | `Complex(nil) # TypeError` | -
 Rational | - | [Rational()](http://ruby-doc.org/core-2.4.0/Kernel.html#method-i-Rational) | `Rational(nil) # TypeError` | -
 Regexp   | [Regexp.try_convert](http://ruby-doc.org/core-2.4.0/Regexp.html#method-c-try_convert) | - | - | -
 IO       | [IO.try_convert](http://ruby-doc.org/core-2.4.0/IO.html#method-c-try_convert) | - | - | -
{:.table-10-20-15-25-X}
