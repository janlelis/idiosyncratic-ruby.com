...
Number of seconds since **1970-01-01 00:00:00 UTC**. This known as [Unix timestamps](https://en.wikipedia.org/wiki/Unix_time). It returns the same value (as string) like [Time#to_i](http://ruby-doc.org/core-2.3.1/Time.html#method-i-to_i):
