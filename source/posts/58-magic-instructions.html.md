...
Part of [Ruby 3.0 Ractor](https://ruby-doc.org/core/Ractor.html), this magic comment helps you to create frozen, sharable objects. It can take one these four values:
...
Differently from the other comments, it can be placed anywhere in the file. It will affect all subsequent statements within the same module scope.
 ...
 [Documentation](https://ruby-doc.org/core/doc/syntax/comments_rdoc.html#label-shareable_constant_value+Directive).

## Also See

- [List of magic comments defined in Ruby's grammar](https://github.com/ruby/ruby/blob/v3_0_0/parse.y#L8085-L8094)